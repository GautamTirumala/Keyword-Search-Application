...
const {
  ...
  searchKeywordInWord,
} = require("../controllers/searchControllers"); // Import the search functions
...
// Search endpoint to find keyword in uploaded documents
...
// Search endpoint to find keyword in a specific document type
